...
@implementation MooeeMathAppDelegate
...
- (void) applicationDidFinishLaunching:(UIApplication*)application
{
	...
	//CCLOG(@"I am here, in did finish launching");
...
//		CCLOG(@"Retina Display Not supported");
	...
	// Run the intro Scene
	//[[CurrentLevel sharedCurrentLevel] setCurrentLevel:[NSNumber numberWithInt:34]];
